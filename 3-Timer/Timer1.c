...
void Timer1_PeriodicTask1(f32 period_ms , void (*callback)(void))
{
...
void Timer1_PeriodicTask2(f32 period_ms , void (*callback)(void))
{
	TCCR1A=0x00;                                   /* Select CTC Operation Mode=4 */
    TCCR1B=0x0D;                                   /* Select CPU_clk/1024[T_tick=128us] */
...
void Timer1_PeriodicTask3(f32 period_ms , void (*callback)(void))
{
